...
public class RunExperimentalDesign {
	...
	public static void runExperimentalDesign(String args) {
		 ...
		 if(arg.equals("g")) {
			 ...
			 double[] tMuRate= {0.05,0.1,0.15} ;
			 double[] rMuRate= {0.005,0.01,0.015};
			 int RunTime = 10;
			 double maxGenerations=300; 
			 ...
			 for(int i=0;i<populationSize.length;i++) {
				 ...
				 RuntaskExperimentalDesign task=new RuntaskExperimentalDesign(project,arg);
			 ...
			 int[] pop= {50,100,150};
			 double[] crossR = {0.6,0.7,0.8};
			 double[] resSp= {0.05,0.1,0.15} ;//0.1
