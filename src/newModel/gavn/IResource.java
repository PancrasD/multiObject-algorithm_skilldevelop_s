...
public class IResource {
		...
		public IResource(Resource resource){
			...
			for(String skill:resource.getSkils().trim().split(" ")){
				...
				this.skillsInfo.put(skillInfo[0], Double.valueOf(skillInfo[1]));//不+1 0-1-2-3
